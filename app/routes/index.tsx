          ...
          <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            ...
            <div className="lg:pb-18 relative bg-black bg-opacity-50 px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pt-32">
              ...
              <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                {email ? (
                  <span className="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium text-yellow-700 shadow-sm hover:bg-yellow-50 sm:px-8">
                    Hello {email}!
                  </span>
                ) : (
